...
import { LogoBox, TextInputBox, TimeCountMc } from "@molecules";
...
export default function CountInputOg(props) {
  ...
  return (
    <div className="loginFormBox">
      ...
      {inputProperties.map((element, index) => (
        <div className="timeInputBox" key={index}>
          <SetPlaceHolder element={element} />
          <TimeCountMc timeOut={element.timeOut} />
        </div>
      ))}
    </div>
  );
